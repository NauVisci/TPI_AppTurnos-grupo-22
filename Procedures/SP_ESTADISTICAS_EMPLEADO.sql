...
--1
--Estad�sticas de un empleado espec�fico (ID 1) en septiembre 2023:
...
--2
--Comparativa de todos los empleados en el �ltimo trimestre:
--EXEC SP_ESTADISTICAS_EMPLEADO
--    @FechaDesde = '2023-07-01',
--    @FechaHasta = '2023-09-30';

--3
--An�lisis de la primera quincena de septiembre:
--EXEC SP_ESTADISTICAS_EMPLEADO
--    @FechaDesde = '2023-09-01',
